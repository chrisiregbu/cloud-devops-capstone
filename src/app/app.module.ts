...
import { DynamicFormItemComponent, DynamicFormComponent, DynamicFormsComponent } from './dynamic-forms/dynamic-forms.component';
...
@NgModule({
  declarations: [
    ...
    DynamicFormItemComponent, DynamicFormComponent, DynamicFormsComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
